...
internal sealed class IntelligenceAgentStateSqliteMigrator
{
    private readonly string _databasePath;
    private readonly IReadOnlyList<
        IntelligenceAgentStateSqliteMigration> _migrations;

    public IntelligenceAgentStateSqliteMigrator(
        string databasePath,
        IReadOnlyCollection<
            IntelligenceAgentStateSqliteMigration> migrations)
    {
        ...
        foreach (var migration in migrations)
        {
            if (migration.Version != expectedVersion)
            {
                throw new InvalidOperationException(
                    "Intelligence agent state migrations must form " +
            ...
            CancellationToken cancellationToken)
    {
        ...
        command.CommandText =
            """
            SELECT Version, Name
            FROM IntelligenceAgentState_SchemaMigrations
            ORDER BY Version;
            """;
            ...
            appliedMigrations)
    {
        ...
        foreach (var appliedMigration in appliedMigrations)
        {
            ...
            {
                throw new InvalidOperationException(
                    "The intelligence agent state database contains " +
            ...
            {
                throw new InvalidOperationException(
                    "The intelligence agent state database migration " +
