...
public sealed class VeteransClaimsSqliteEvidenceDevelopmentPlanRepositoryTests
{
    ...
    [Fact]
    public async Task Repository_RoundTripsEvidenceDevelopmentResult()
    {
        var databasePath = Path.GetTempFileName();
        ...
        try
        {
            ...
            var veteran = new Veteran
            {
                Id = new VeteranId("veteran-result-001")
            };
            ...
            var claim = new Claim
            {
                Id = new ClaimId("claim-result-001"),
                VeteranId = veteran.Id
            };
            ...
            var issue = new ClaimIssue
            {
                Id = new ClaimIssueId("issue-result-001"),
                ClaimId = claim.Id,
                ClaimIssueType =
                    ClaimIssueTypes.ServiceConnection
            };
            ...
            var authority = new RegulatoryAuthority
            {
                Id = new RegulatoryAuthorityId("authority-result-001"),
                AuthorityType = "Regulation",
                Citation = "38 CFR",
                Title = "Veterans Affairs"
            };
            ...
            var provision = new RegulatoryProvision
            {
                Id = new RegulatoryProvisionId("provision-result-001"),
                RegulatoryAuthorityId = authority.Id,
                ProvisionType = RegulatoryProvisionTypes.Requirement,
                Citation = "38 CFR 3.303"
            };
            ...
            var requirement = new Requirement
            {
                Id = new RequirementId("requirement-result-001"),
                RegulatoryProvisionId = provision.Id,
                Description = "Required element."
            };
            ...
            var gap = new EvidenceGap
            {
                Id = new EvidenceGapId("gap-result-001"),
                ClaimIssueId = issue.Id,
                RequirementId = requirement.Id,
                Description = "Missing supporting evidence."
            };
            ...
            await repository
                .AddEvidenceDevelopmentResultAsync(result);
