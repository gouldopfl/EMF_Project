...
public sealed class EvidenceLineageServiceTests
{
    ...
    [Fact]
    public async Task GetGeneratedFromDistanceAsync_ReturnsDirectDistance()
    {
        var repository = new InMemoryEvidenceRepository();
        var service = new EvidenceLineageService(repository);
        ...
        var generated = new Artifact
        {
            Id = new ArtifactId("distance-generated-001"),
            Name = "Generated",
            ArtifactType = "intelligence-output"
        };
        ...
        var source = new Artifact
        {
            Id = new ArtifactId("distance-source-001"),
            Name = "Source",
            ArtifactType = "file"
        };
        ...
        var result =
            await service.GetGeneratedFromDistanceAsync(
                generated.Id,
                source.Id);
    ...
    [Fact]
    public async Task GetGeneratedFromDistanceAsync_ReturnsRecursiveDistance()
    {
        var repository = new InMemoryEvidenceRepository();
        var service = new EvidenceLineageService(repository);
        ...
        var generated = new Artifact
        {
            Id = new ArtifactId("distance-generated-002"),
            Name = "Generated",
            ArtifactType = "intelligence-output"
        };
        ...
        var intermediate = new Artifact
        {
            Id = new ArtifactId("distance-intermediate-002"),
            Name = "Intermediate",
            ArtifactType = "intelligence-output"
        };
        ...
        var source = new Artifact
        {
            Id = new ArtifactId("distance-source-002"),
            Name = "Source",
            ArtifactType = "file"
        };
    ...
    [Fact]
    public async Task GetGeneratedFromDistanceAsync_ReturnsNullWhenNoPathExists()
    {
        var repository = new InMemoryEvidenceRepository();
        var service = new EvidenceLineageService(repository);
        ...
        var first = new Artifact
        {
            Id = new ArtifactId("distance-first-001"),
            Name = "First",
            ArtifactType = "file"
        };
        ...
        var second = new Artifact
        {
            Id = new ArtifactId("distance-second-001"),
            Name = "Second",
            ArtifactType = "file"
        };
    ...
    [Fact]
    public async Task GetGeneratedFromRootsAsync_ReturnsDirectRoot()
    {
        var repository = new InMemoryEvidenceRepository();
        var service = new EvidenceLineageService(repository);
        ...
        var generated = new Artifact
        {
            Id = new ArtifactId("roots-generated-001"),
            Name = "Generated",
            ArtifactType = "intelligence-output"
        };
        ...
        var source = new Artifact
        {
            Id = new ArtifactId("roots-source-001"),
            Name = "Source",
            ArtifactType = "file"
        };
    ...
    [Fact]
    public async Task GetGeneratedFromRootsAsync_ReturnsUltimateRoot()
    {
        var repository = new InMemoryEvidenceRepository();
        var service = new EvidenceLineageService(repository);
        ...
        var generated = new Artifact
        {
            Id = new ArtifactId("roots-generated-002"),
            Name = "Generated",
            ArtifactType = "intelligence-output"
        };
        ...
        var intermediate = new Artifact
        {
            Id = new ArtifactId("roots-intermediate-002"),
            Name = "Intermediate",
            ArtifactType = "intelligence-output"
        };
        ...
        var source = new Artifact
        {
            Id = new ArtifactId("roots-source-002"),
            Name = "Source",
            ArtifactType = "file"
        };
    ...
    [Fact]
    public async Task GetGeneratedFromRootsAsync_ReturnsBranchingRoots()
    {
        var repository = new InMemoryEvidenceRepository();
        var service = new EvidenceLineageService(repository);
        ...
        var generated = new Artifact
        {
            Id = new ArtifactId("roots-generated-003"),
            Name = "Generated",
            ArtifactType = "intelligence-output"
        };
        ...
        var firstSource = new Artifact
        {
            Id = new ArtifactId("roots-source-003-a"),
            Name = "First source",
            ArtifactType = "file"
        };
        ...
        var secondSource = new Artifact
        {
            Id = new ArtifactId("roots-source-003-b"),
            Name = "Second source",
            ArtifactType = "file"
        };
    ...
    [Fact]
    public async Task GetGeneratedFromLeavesAsync_ReturnsDirectLeaf()
    {
        var repository = new InMemoryEvidenceRepository();
        var service = new EvidenceLineageService(repository);
        ...
        var source = new Artifact
        {
            Id = new ArtifactId("leaves-source-001"),
            Name = "Source",
            ArtifactType = "file"
        };
        ...
        var generated = new Artifact
        {
            Id = new ArtifactId("leaves-generated-001"),
            Name = "Generated",
            ArtifactType = "intelligence-output"
        };
    ...
    [Fact]
    public async Task GetGeneratedFromLeavesAsync_ReturnsUltimateLeaf()
    {
        var repository = new InMemoryEvidenceRepository();
        var service = new EvidenceLineageService(repository);
        ...
        var source = new Artifact
        {
            Id = new ArtifactId("leaves-source-002"),
            Name = "Source",
            ArtifactType = "file"
        };
        ...
        var intermediate = new Artifact
        {
            Id = new ArtifactId("leaves-intermediate-002"),
            Name = "Intermediate",
            ArtifactType = "intelligence-output"
        };
        ...
        var generated = new Artifact
        {
            Id = new ArtifactId("leaves-generated-002"),
            Name = "Generated",
            ArtifactType = "intelligence-output"
        };
    ...
    [Fact]
    public async Task GetGeneratedFromLeavesAsync_ReturnsBranchingLeaves()
    {
        var repository = new InMemoryEvidenceRepository();
        var service = new EvidenceLineageService(repository);
        ...
        var source = new Artifact
        {
            Id = new ArtifactId("leaves-source-003"),
            Name = "Source",
            ArtifactType = "file"
        };
        ...
        var first = new Artifact
        {
            Id = new ArtifactId("leaves-generated-003-a"),
            Name = "First generated",
            ArtifactType = "intelligence-output"
        };
        ...
        var second = new Artifact
        {
            Id = new ArtifactId("leaves-generated-003-b"),
            Name = "Second generated",
            ArtifactType = "intelligence-output"
        };
        ...
        Assert.Equal(2, result.Count);
        Assert.Contains(result, artifact => artifact.Id == first.Id);
