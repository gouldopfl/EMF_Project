...
public sealed class VeteransClaimsSqliteMigrationTests
{
    ...
    public async Task InitializeAsync_RecordsCurrentMigrationsOnce()
    {
        ...
        try
        {
                ...
                tableCommand.CommandText =
                    ...
                    WHERE type = 'table'
                      AND name IN (
                          ...
                          'VeteransClaims_ExposureArtifacts',
                          'VeteransClaims_ClaimIssueExposures',
            ...
            Assert.True(await reader.ReadAsync());
            Assert.Equal(37, reader.GetInt32(0));
            ...
            Assert.True(await reader.ReadAsync());
            Assert.Equal(38, reader.GetInt32(0));
            ...
            Assert.True(await reader.ReadAsync());
            Assert.Equal(39, reader.GetInt32(0));
            ...
            Assert.True(await reader.ReadAsync());
            Assert.Equal(40, reader.GetInt32(0));
            ...
            Assert.True(await reader.ReadAsync());
            Assert.Equal(46, reader.GetInt32(0));
            ...
            Assert.True(await reader.ReadAsync());
            Assert.Equal(47, reader.GetInt32(0));
            ...
            Assert.True(await reader.ReadAsync());
            Assert.Equal(48, reader.GetInt32(0));
            ...
            Assert.True(await reader.ReadAsync());
            Assert.Equal(49, reader.GetInt32(0));
            ...
            Assert.True(await reader.ReadAsync());
            Assert.Equal(52, reader.GetInt32(0));
            ...
            Assert.True(await reader.ReadAsync());
            Assert.Equal(53, reader.GetInt32(0));
            ...
            Assert.True(await reader.ReadAsync());
            Assert.Equal(54, reader.GetInt32(0));
            ...
            Assert.True(await reader.ReadAsync());
            Assert.Equal(55, reader.GetInt32(0));
            ...
            Assert.True(await reader.ReadAsync());
            Assert.Equal(56, reader.GetInt32(0));
            ...
            Assert.True(await reader.ReadAsync());
            Assert.Equal(57, reader.GetInt32(0));
            ...
            Assert.True(await reader.ReadAsync());
            Assert.Equal(58, reader.GetInt32(0));
            ...
            Assert.True(await reader.ReadAsync());
            Assert.Equal(59, reader.GetInt32(0));
            ...
            Assert.True(await reader.ReadAsync());
            Assert.Equal(60, reader.GetInt32(0));
            Assert.Equal(
            ...
            Assert.True(await reader.ReadAsync());
            Assert.Equal(61, reader.GetInt32(0));
            Assert.Equal(
            ...
            Assert.True(await reader.ReadAsync());
            Assert.Equal(62, reader.GetInt32(0));
            Assert.Equal(
            ...
            Assert.True(await reader.ReadAsync());
            Assert.Equal(63, reader.GetInt32(0));
            Assert.Equal(
            ...
            Assert.True(await reader.ReadAsync());
            Assert.Equal(64, reader.GetInt32(0));
            Assert.Equal(
            ...
            Assert.True(await reader.ReadAsync());
            Assert.Equal(65, reader.GetInt32(0));
            Assert.Equal(
            ...
            Assert.True(await reader.ReadAsync());
            Assert.Equal(66, reader.GetInt32(0));
            Assert.Equal(
            ...
            Assert.True(await reader.ReadAsync());
            Assert.Equal(67, reader.GetInt32(0));
            Assert.Equal(
            ...
            Assert.True(await reader.ReadAsync());
            Assert.Equal(68, reader.GetInt32(0));
            Assert.Equal(
            ...
            Assert.True(await reader.ReadAsync());
            Assert.Equal(70, reader.GetInt32(0));
            Assert.Equal(
            ...
            var remainingMigrations = new[]
            {
                (72, "AddReviewerPageSelection"),
                (73, "AddMedicationRecords"),
            ...
            {
                Assert.True(await reader.ReadAsync());
                Assert.Equal(expected.Item1, reader.GetInt32(0));
                Assert.Equal(expected.Item2, reader.GetString(1));
                Assert.True(
                    DateTimeOffset.TryParse(
                        reader.GetString(2),
                        out _));
    ...
    [Fact]
    public async Task InitializeAsync_EnforcesReviewedLiteratureLogicalUniqueness()
    {
        var databasePath =
            Path.Combine(
                Path.GetTempPath(),
