...
public sealed class EmailAttachmentWorkflowActivityTests
{
    ...
    [Fact]
    public async Task ExecuteAsync_SkipsAlreadyProcessedUnchangedEmail()
    {
        var repository =
            new InMemoryEvidenceRepository();
        ...
        var email = new Artifact
        {
            Id = new ArtifactId("email-repeat"),
            Name = "repeat.eml",
            ArtifactType = "file",
            Metadata = new Dictionary<string, object>
            {
        ...
        await activity.ExecuteAsync(
            ...
            {
                WorkflowId =
                    new WorkflowId("workflow-email-first")
            });
        ...
        await activity.ExecuteAsync(
            ...
            {
                WorkflowId =
                    new WorkflowId("workflow-email-second")
            });
